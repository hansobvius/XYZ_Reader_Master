...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Toolbar mToolBar = (Toolbar) mRootView.findViewById(R.id.fragment_toolbar);
        getActivityCast().setSupportActionBar(mToolBar);
        getActivityCast().getSupportActionBar().setDisplayShowTitleEnabled(false);
        CollapsingToolbarLayout collapsingToolbarLayout = (CollapsingToolbarLayout) mRootView.findViewById(R.id.collapsing_fragment);
